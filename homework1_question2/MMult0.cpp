...
int main(int argc, char** argv) {
  ...
  for (long p = PFIRST; p < PLAST; p += PINC) {
    ...
    double time = t.toc();
    double flops = NREPEATS*m*n*k*10/1e9/time; // TODO: calculate from m, n, k, NREPEATS, time
    double bandwidth = NREPEATS*m*n*k*sizeof(double)/1e9/time; // TODO: calculate from m, n, k, NREPEATS, time
